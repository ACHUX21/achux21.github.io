---
title: "TwoMillion (HackTheBox): API Manipulation → Command Injection → Kernel Exploit"
published: 2023-08-10
description: "Manipulating the HackTheBox API endpoints to escalate privileges, exploiting a command injection in the admin panel, and using an old kernel exploit for root."
tags: [HackTheBox, API, Command Injection, Kernel Exploit, Privilege Escalation]
category: Box
image: ./cover.png
draft: false
---
