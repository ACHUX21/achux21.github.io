...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Security Research & Capture The Flag",

	// 站点 URL
	site_url: "https://achux21.github.io",

	// 站点描述
	description:
		"A collection of CTF writeups and security research — web exploitation, privilege escalation, reverse engineering, and more.",
